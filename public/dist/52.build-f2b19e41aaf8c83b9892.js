...
module.exports = __webpack_require__.p + "lens.svg";
...
var update = __webpack_require__(81)("4fc3d5bd", content, true, {});
...
var HeaderMenu = function HeaderMenu() {
    return __webpack_require__.e/* import() */(48/* duplicate */).then(__webpack_require__.bind(null, 94));
};

// import HeaderMenu from '../shared/HeaderMenu.vue';

/* harmony default export */ __webpack_exports__["default"] = ({
    computed: _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* mapGetters */])(['recentDeleteMode', 'appActive', 'menuTitle'])),
    watch: {
    ...
    methods: _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_vuex__["b" /* mapMutations */])(['setRecentDeleteMode', 'setMenuTitle', 'setPageTitle']), {
        goToSearch: function goToSearch() {
            this.$router.push({ name: 'search' });
        },
        openSearch: function openSearch() {
            __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('togglePopupSearch', true);
        },
        setMenuTitleCB: function setMenuTitleCB(state) {
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_3__mixins__["a" /* altMixins */]]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_swiper__ = __webpack_require__(837);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var singleCarouselSlider = function singleCarouselSlider() {
  return __webpack_require__.e/* import() */(52).then(__webpack_require__.bind(null, 853));
};
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
  ...
  computed: _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuex__["a" /* mapGetters */])(['appActive'])),
  watch: {
    carouselSub: function carouselSub() {
      if (!this.checkMountedWatchFlag) {
        this.page = 1;
        this.offset = 0;
        this.sliderList = [], this.subSections = this.carouselSub;
        this.getContents();
        this.initSwiper();
  ...
  props: ['carouselSub'],
  methods: _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuex__["c" /* mapActions */])(['actGetSections', 'actGetContentsByUrl', 'actGetContentsById']), {
    getContents: function getContents() {
      ...
      var subsectionsListDetails = undefined;

      subsectionsListDetails = this.subSections.filter(function (menu) {
      ...
      if (editorPick.external_id) {
        ...
        this.actGetContentsByUrl(urlObj).then(function (response) {
          // console.log('[carousel.vue | actGetContentsByUrl | response | ]', response);

          _this2.processContents(response);
        }, function (error) {});
      } else {
        this.actGetContentsById({
          ...
          __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('toggleOfflineEvent', false);
          _this2.processContents(response);
        }, function (error) {
          _this2.toggleLoader(false);
          __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('toggleOfflineEvent', true);
        });
      }
    },
    processContents: function processContents(response) {
      var arrSlider = [];
      var singleSlider = undefined;
      var idCreate = undefined;
      ...
      var hiddenClass = undefined;
      var paginationId = document.getElementById('carousel-pagination');
      if (paginationId) {
    ...
    initSwiper: function initSwiper() {
      ...
      var _this = this;
      // NOTE swiper
      if (!this.swiper && __WEBPACK_IMPORTED_MODULE_3_swiper__["a" /* default */]) {
        this.swiper = new __WEBPACK_IMPORTED_MODULE_3_swiper__["a" /* default */]('.home-carousel', {
          slidesPerView: 1,
          spaceBetween: 30,
          debugger: true,
          clickable: true,
  ...
  mixins: [__WEBPACK_IMPORTED_MODULE_1__mixins__["a" /* altMixins */]]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_mutations__ = __webpack_require__(13);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ['singleSlider'],
  methods: _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuex__["b" /* mapMutations */])(['setHasBts', 'setPlayerScreenSource']), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuex__["c" /* mapActions */])(['actCheckinFavouriteSeries', 'actCheckinFavouriteMedia', 'actDeleteFavouriteSeries', 'actDeleteFavouriteMedia', 'actAddtoFavouriteSeries', 'actAddtoFavouriteMedia', 'actGetMediaSeries', 'actGetMediaVideo', 'actGetEpisodes']), {
    bannerClick: function bannerClick(e, item) {
    ...
    playCarouselItem: function playCarouselItem(item) {
      var _this2 = this;
      ...
      __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit("togglePlayerScreenFlagEnable", true);
      // Make the browser into fullscreen mode
      this.makeFullscreen();

      // Defining the media API fetch method
      var fetchMediaAPIcall = function fetchMediaAPIcall() {
        if (_this2.contentName === 'show') {
          _this2.actGetMediaSeries(_this2.contentId).then(function (response) {
            // Get the seasons data
            var seasons = response.seasons;
            // If seasons are not there, there is no point of continuing
            if (!(seasons && seasons.length)) return;
            // Get the season id
            var seriesId = _this2.contentId;
            ...
            _this2.actGetEpisodes({ seriesId: seriesId, seasonId: seasonId, limit: limit, offset: offset }).then(function (response) {
              var mediaIndex = 0;
              ...
              if (altUser && localStorage.getItem('mediaProgressList')) {
                ...
                if (mediaProgressList && mediaProgressList.length) {
                  var lastPlayedMediaId = mediaProgressList[0].media_id;
              ...
              var episode = _this2.parseContents(response.episodes[mediaIndex]);

              // Finally emit an event to playerscreen to play the content
              __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit("toggleSendDataToPlayerScreen", episode);
            }, function (error) {});
          }).catch(function (error) {});
        } else if (_this2.contentName === 'media' || _this2.contentName === 'episode') {
          _this2.actGetMediaVideo(_this2.contentId).then(function (response) {
            // Parse the media info
            var media = _this2.parseContents(response);
            // Emit an event to playerscreen to play the content
            __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit("toggleSendDataToPlayerScreen", media);
          }).catch(function (error) {});
        }
      };

      // Check whether browser supports orientation or not
      window.screen.orientation.lock('landscape').then(function (response) {
        fetchMediaAPIcall();
      }).catch(function (error) {
        fetchMediaAPIcall();
      });
    },
    checkScreenRotationType: function checkScreenRotationType() {
    ...
    makeFullscreen: function makeFullscreen() {
      var vContain = document.getElementById('v-contain');
    ...
    landscapeRotation: function landscapeRotation() {
      var _this3 = this;

      var _this = this;
      screen.orientation.lock('landscape').then(function (response) {
        if (_this3.contentName === 'show') {
          _this3.actGetMediaSeries(_this3.contentId).then(function (response) {
            // Get the latest episode from the response
            var latest_episode = response.latest_episode;
            // If no latest episode, exit
            if (!latest_episode) return;
            // Parse the episode info
            var episode = _this3.parseContents(latest_episode);

            __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit("toggleSendDataToPlayerScreen", episode);
          }).catch(function (error) {});
        } else if (_this3.contentName === 'media' || _this3.contentName === 'episode') {
          _this3.actGetMediaVideo(_this3.contentId).then(function (response) {
            // Parse the media info
            var media = _this3.parseContents(response);
            __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit("toggleSendDataToPlayerScreen", media);
          }).catch(function (error) {});
        }
      }, function (error) {});
    },
    detailsPageRedirection: function detailsPageRedirection(item) {
      if (window.mobileAnalyticsClient) {

        var page_info = item.contentName && item.contentName == 'show' ? 'show details' : 'movie details';
        var route = this.$route.name;

        var event_source = route === 'movies' ? 'movie' : route === 'shows' ? 'show' : route;
    ...
    removeFromFavourite: function removeFromFavourite() {
      var _this4 = this;

      var contentName = this.singleSlider.contentName;

      if (contentName == 'media' || contentName == 'episode') {
        this.actDeleteFavouriteMedia(this.favCheckId).then(function (response) {
          _this4.favouriteItem = false;
        }, function (error) {});
      } else if (contentName == 'show') {
        this.actDeleteFavouriteSeries(this.favCheckId).then(function (response) {
          _this4.favouriteItem = false;
        }, function (error) {});
      }
    },
    checkFavourite: function checkFavourite() {
      if (!localStorage.getItem('altUser')) {
        return;
      }
    ...
    checkFavouriteMedia: function checkFavouriteMedia() {
      var _this5 = this;

      this.actCheckinFavouriteMedia(this.favCheckId).then(function (response) {
        if (response.status && response.status == 'ok') {
          _this5.favouriteItem = true;
        } else {
          _this5.favouriteItem = false;
        }
      }, function (error) {
        _this5.favouriteItem = false;
      });
    },
    checkFavouriteSeries: function checkFavouriteSeries() {
      var _this6 = this;

      this.actCheckinFavouriteSeries(this.favCheckId).then(function (response) {
        if (response.status && response.status == 'ok') {
          _this6.favouriteItem = true;
        } else {
          _this6.favouriteItem = false;
        }
      }, function (error) {});
    },
    addToFavourite: function addToFavourite() {
      var _this7 = this;
      ...
      if (localStorage.getItem('altUser')) {
        ...
        if (contentName == 'media' || contentName == 'episode') {
          this.actAddtoFavouriteMedia(this.favCheckId).then(function (response) {
            _this7.favouriteItem = true;
          }, function (error) {
            // If error code is 404, ie. "Media not available for domain row"
            if (error.code == 404) {
              // show the geo block popup
              __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('toggleGeoBlockEvent', true);
            } else {
              // show the add to favourite error message
              __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('toggleVideoAddToFavError', true);
            }

            __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('toggleVideoAddToFavErrorVideoPause', true);
          ...
          this.actAddtoFavouriteSeries(this.favCheckId).then(function (response) {
            _this7.favouriteItem = true;
          }, function (error) {
            // If error code is 404, ie. "Media not available for domain row"
            if (error.code == 404) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__main__["eventBus"].$emit('togglePlayerFavSigninPopupEvent', true);
      }
    }
  }),
...
// module
exports.push([module.i, ".carousel-height{width:100%!important}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ssr_window__ = __webpack_require__(236);
/**
 * Dom7 2.1.3
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dom7_dist_dom7_modular__ = __webpack_require__(707);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ssr_window__ = __webpack_require__(236);
/**
 * Swiper 4.5.0
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, _vm._l((_vm.sliderList), function(slider) {
    return (_vm.sliderList) ? _c('div', {
      staticClass: "swiper-slide carousel-height"
    }, [(slider) ? _c('single-slider', {
      attrs: {
        "singleSlider": slider
      }
    }) : _vm._e()], 1) : _vm._e()
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return (_vm.singleSlider && _vm.singleSlider.carousel) ? _c('div', {
    staticStyle: {
      "width": "100%"
    }
  }, [(_vm.singleSlider.comingSoon) ? _c('p', {
    staticClass: "alt-tag comingSoonPosition"
  }, [_vm._v("Coming Soon")]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "carousel"
  }, [_c('div', {
    staticClass: "row"
  }, [_c('div', {
    staticClass: "col-xs-4"
  }, [(_vm.favouriteItem) ? _c('img', {
    staticClass: "home-icons",
    attrs: {
      "src": "src/assets/home/favIcon.png",
      "alt": "home-icon"
    },
    on: {
      "click": _vm.removeFromFavourite
    }
  }) : _c('img', {
    staticClass: "home-icons",
    attrs: {
      "src": "src/assets/home/nonFavIcon.png",
      "alt": "home-icon"
    },
    on: {
      "click": _vm.addToFavourite
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "col-xs-4"
  }, [_c('button', {
    staticClass: "btn carousel-button",
    attrs: {
      "type": "button"
    }
  }, [_c('div', {
    staticClass: "home-play-icon-listing",
    on: {
      "click": function($event) {
        _vm.playCarouselItem(_vm.singleSlider)
      }
    }
  }, [_c('img', {
    staticClass: "home-icon",
    attrs: {
      "src": "src/assets/home/btn_Play.png",
      "alt": "home-icon"
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "home-play-icon"
  }, [_vm._v("play")])])])]), _vm._v(" "), _c('div', {
    staticClass: "col-xs-4"
  }, [_c('img', {
    staticClass: "home-icons",
    attrs: {
      "src": "src/assets/home/btn_info.png",
      "alt": "home-icon"
    },
    on: {
      "click": function($event) {
        _vm.detailsPageRedirection(_vm.singleSlider)
      }
    }
  })])])]), _vm._v(" "), (_vm.singleSlider && _vm.singleSlider.carousel) ? _c('img', {
    attrs: {
      "src": _vm.singleSlider.carousel,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "recent-header"
  }, [_c('header-menu'), _vm._v(" "), _c('div', {
    staticClass: "app-bar"
  }, [_c('button', {
    staticClass: "menu-bread",
    attrs: {
      "type": "button",
      "id": "showMenu",
      "aria-label": "showMenu",
      "aria-labelledby": "showMenu"
    },
    on: {
      "click": function($event) {
        _vm.toggleNavMenu(true)
      }
    }
  }, [_c('span', {
    ...
    staticClass: "icon-bar"
  })]), _vm._v(" "), (_vm.menuTitle) ? _c('h4', {
    staticClass: "header-title"
  }, [_vm._v(_vm._s(_vm.menuTitle))]) : _c('img', {
...
//# sourceMappingURL=52.build-f2b19e41aaf8c83b9892.js.map