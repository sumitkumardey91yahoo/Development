...
<template lang="html">
    <div class="paytm-campaign-container">
        <div class="paytm-campaign-header">
            <div class="alt-smpl-head">
                <img src="/src/assets/altlogo144.png" alt="" class="paytm-campaign-width">
            </div>
        </div>
        <div class="paytm-campaign-body">
            <p class="paytm-header" v-if="partnerDetails && partnerDetails.offerText">{{partnerDetails.offerText}}</p>
            <form autocomplete="off">
                <div class="form-group">
                    <input type="email" name="email" id="email_text" placeholder="" class="form-control paytm-campaign-input" style="font-size: 15px;" v-model="email">
                ...
                <input type="submit" class="grad-btn submit-btn btn" style="margin-top: 40px;" id="textEmail" @click.prevent="paytmGetEmail" v-model="altConfigPromo.submitButtonText">
            </form>
            <a href="" id="paytmLinkId"></a>
        </div>
        <div class="paytm-campaign-footer" id="paytm-footer">
            <p>Already registered ALTBalaji user? <u @click="goToSign">Sign in here</u></p>
        </div>
    </div>
</template>
...
export default {
        ...
        pageViewEvent() {
          // console.log('[pageViewEvent]');
            ...
            if (window.mobileAnalyticsClient) {
              ...
              pageSelectAttributes.page_title = "promo-landing";
    ...
    mounted() {
        ...
        let _this = this;
        setTimeout(function() {
            // console.log("paytmCampaignLogin.vue | mounted |",window.mobileAnalyticsClient);
            _this.pageViewEvent()
        },3000);
